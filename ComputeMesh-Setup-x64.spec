...
a = Analysis(
    ...
    hiddenimports=['services', 'services.appliance_dashboard', 'services.appliance_dashboard.server', 'services.updater', 'services.updater.auto_updater', 'tools', 'tools.appliance', 'tools.appliance.hardware_detector', 'tools.appliance.appliance_config', 'tools.security', 'tools.security.ed25519_verify', 'tools.security.signing_keys', 'PIL', 'PIL.ImageTk', 'PIL.ImageDraw', 'pystray'],
    hookspath=[],
    hooksconfig={},
    runtime_hooks=[],
    excludes=[],
