...
def test_gpu_promo_transport_binds_authenticated_session_key_and_records_roundtrip() -> None:
...
def test_gpu_promo_transport_fails_closed_without_authenticated_key() -> None:
    transport = SessionAuthenticatedGpuPromoTransport(
