...
| :--- | :--- | :--- | :--- | :--- |
| **Gateway Subsystem** | `test_gateway_server`, `test_gateway_auth`, `test_gateway_security`, `test_catalog_and_pricing`, `test_inference_engine` | **41** | `[OK]` | ~0.88s |
...
| **Appliance & Hardware Daemon**| `test_appliance_config`, `test_dashboard_server`, `test_hardware_detector`, `test_multi_gpu_launcher` | **10** | `[OK]` | ~1.40s |
| **Scheduler & Orchestrator** | `test_placement`, `test_health_monitor`, `test_evidence_bundle`, `test_multi_gpu_planner`, `test_model_cache_manager`, `test_handlers`, `test_state_machine`, `test_persistence_v2` | **71** | `[OK]` | ~0.62s |
| **Runtime & Mesh Network** | `test_tcp_relay`, `test_mesh_transport`, `test_shared_trial`, `test_shared_run_evidence`, `test_rpc_spike` | **57** | `[OK]` | ~4.98s |
| **Configuration & Performance** | `test_config`, `test_performance_harness`, `test_gguf_manifest`, `test_network_benchmark`, `test_llama_bench_adapter`, `test_auto_updater` | **36** | `[OK]` | ~0.13s |
| **TOTAL** | **All 8 Subsystems** | **278** | `[ALL PASS]` | **~9.23s** |
