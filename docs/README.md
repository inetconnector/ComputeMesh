...
4. Root `README.md` / `README.de.md` — project overview and detailed public engineering paths.
5. The nearest component `README.md` — implementation details for a specific subsystem.
6. Root `ARCHITECTURE.md`, `PROTOCOL.md`, `THREAT_MODEL.md`, `IMPLEMENTATION_PLAN.md` and ADRs — target/historical design context.
7. Root `state.md` — detailed public engineering/evidence chronology.
