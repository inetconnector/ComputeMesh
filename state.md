...
**Last updated:** 2026-08-23 20:05 CEST
...
**Public release:** `v1.1.3` public release with Live Genesis Network Telemetry & NodeOS Appliance integration (`cm-miner-rig-01` AMD Vega 10 + RTX 3080 = 18.58 GB Usable VRAM Pool on Portal Homepage and Status Grid)
...
- current public portal indexing tag: `v1.1.3` at the Search Console verified sitemap state
