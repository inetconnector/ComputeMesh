...
**Last updated:** 2026-08-23 19:38 CEST
...
**Public release:** `v1.1.2` public release with Fullscreen Graphical Kiosk Dashboard (Chromium kiosk + Openbox X11 session auto-launching http://127.0.0.1:8080 directly on physical monitor)
...
- current public portal indexing tag: `v1.1.2` at the Search Console verified sitemap state
