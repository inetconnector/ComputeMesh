...
**Last updated:** 2026-08-23 15:40 CEST
...
**Public release:** `v1.0.6` public release with AES-256-GCM authenticated EncryptedVault, zero-plaintext storage of wallets/IBAN, server env key deployment, and DiskStation backup
...
- current public portal indexing tag: `v1.0.6` at the Search Console verified sitemap state
