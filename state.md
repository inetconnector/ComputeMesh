...
**Last updated:** 2026-08-23 20:25 CEST
...
**Public release:** `v1.1.4` public release with Native 64-bit Windows PE GUI Executable (`ComputeMesh-Setup-x64.exe` standalone desktop agent, hardware telemetry, and tray UI)
...
- current public portal indexing tag: `v1.1.4` at the Search Console verified sitemap state
