...
**Last updated:** 2026-08-23 15:26 CEST
...
**Public release:** `v1.0.4` public portal release with payment service provider (Stripe, EVM smart contracts) and escrow governance disclosure
...
- current public portal indexing tag: `v1.0.4` at the Search Console verified sitemap state
