...
**Last updated:** 2026-08-23 15:31 CEST
...
**Public release:** `v1.0.5` public portal release with comprehensive data-at-rest encryption (AES-256-GCM), zero-prompt logging, and DSGVO/GDPR security standards
...
- current public portal indexing tag: `v1.0.5` at the Search Console verified sitemap state
