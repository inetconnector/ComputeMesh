...
**Last updated:** 2026-08-23 15:44 CEST
...
**Public release:** `v1.0.7` public release with 2-tier provider payout architecture (Instant Crypto USDC/USDT vs. Stripe Connect Express SEPA verification)
...
- current public portal indexing tag: `v1.0.7` at the Search Console verified sitemap state
