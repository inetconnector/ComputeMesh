...
**Last updated:** 2026-08-23 18:57 CEST
...
**Public release:** `v1.1.0` public release with True Hybrid Bootable NodeOS appliance images (DOS/MBR boot partition + UEFI EFI system partition) for full balenaEtcher/Rufus USB flashing compatibility
...
- current public portal indexing tag: `v1.1.0` at the Search Console verified sitemap state
