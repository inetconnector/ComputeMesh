...
**Last updated:** 2026-08-23 15:50 CEST
...
**Public release:** `v1.0.8` public release with legally watertight Terms of Service (fully-backed merchant revenue principle, zero pre-financing liability, promotional test credits exclusion)
...
- current public portal indexing tag: `v1.0.8` at the Search Console verified sitemap state
