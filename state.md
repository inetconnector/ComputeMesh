...
**Last updated:** 2026-08-23 16:07 CEST
...
**Public release:** `v1.0.9` public release with authentic Public Alpha telemetry, Genesis mesh status, and elimination of template placeholder metrics
...
- current public portal indexing tag: `v1.0.9` at the Search Console verified sitemap state
