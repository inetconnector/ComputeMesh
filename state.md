...
**Last updated:** 2026-08-24 15:32 CEST
...
- canonical merged **code baseline before this documentation close-out**: `916e845` (`feat(billing): record settlement transfer currency`)
...
- pushed `main` contains the `v1.2.9` release commit `e2612d2f01802527f5eb40569c88df57cb5c09dc` plus subsequent server-side Stripe testmode commits through `916e845` (`feat(billing): record settlement transfer currency`); the webserver has fast-forward deployed this commit and `computemesh-gateway.service` is active on it;
