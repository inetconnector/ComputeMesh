...
**Last updated:** 2026-08-23 19:22 CEST
...
**Public release:** `v1.1.1` public release with Complete Debian 13 Live SquashFS Appliance (turnkey rootfs, autostart services, embedded web dashboard on port 8080, tty1 live physical console monitor, and hybrid MBR/UEFI bootloaders)
...
- current public portal indexing tag: `v1.1.1` at the Search Console verified sitemap state
