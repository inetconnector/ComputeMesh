...
**Last updated:** 2026-08-23 15:22 CEST
...
**Public release:** `v1.0.3` public portal release with provider settlement terms, $25 minimum payout threshold, and bootstrap phase disclosure
...
- current public portal indexing tag: `v1.0.3` at the Search Console verified sitemap state
